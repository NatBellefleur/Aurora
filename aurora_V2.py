#VECTOR APPROACH --> FINCH SPECIFIC
...
# area=0.096576*(1/4) #square meters

# total_energy = simps (intensity * area * alignments,times)

# print(f"Total energy absorbed over {times[-1]} seconds is {round(total_energy)} joules")
